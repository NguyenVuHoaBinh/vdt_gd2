...
//    public Map<String, String> sendPrompt(String message, String role) {
//        HttpHeaders headers = new HttpHeaders();
//        headers.setContentType(MediaType.APPLICATION_JSON);
//        headers.setBearerAuth(GEMINI_KEY);
//
...
//        ResponseEntity<Map> response = restTemplate.exchange(GEMINI_URL, HttpMethod.POST, requestEntity, Map.class);
//
